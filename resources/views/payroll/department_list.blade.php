                    ...
                    <div class="panel-body">
                        ...
                        <div class=" x_panel">
                          <div style="display: flex;">
                              ...
                              <input type="hidden" id="ruta_department_add" value="{{ route('add_department') }}"/>
                            ...
                            @else
                              <h5>Departments:</h5>
                                <input type="hidden" id="id_modify_department_add" value="{{ route('modify_department') }}"/>
                             <div class="central">
                                    ...
                                    @foreach($info as $inf)
                                        <li><form class="form-inline">
                                                <div class="form-group mb-2">
                                                      ...
                                                      <!-- <label for="inputName{{$inf['id']}}"><i class="fa fa-building-o"></i> </label>-->
