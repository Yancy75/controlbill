            ...
            <div class="col-md-11 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="centar_horizontal"><h3 class="th3"><span class="th3ex">{{$supermarket['name']}} - Modify Sale</span></h3>  </div>
                        <div class="row">
                            <div class="col-sm-8 offset-md-2">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form method="post" action="{{ route('modifying_sale', ["id_supermarket" => $supermarket['id']]) }}" class="form-horizontal form-label-left">
                                            @csrf
                                            <input type="hidden" id="inputIdSupermarket" name="inputIdSupermarket" value="{{$supermarket['id']}}">
                                            <input type="hidden" id="inputIdSale" name="inputIdSale" value="{{$info['id']}}">
                                            ...
                                            <div class="float-right">
                                                <a href="{{ route("view_sale", ["id" => $supermarket['id']]) }}" class="btn btn-danger by"><i class="fa fa-close"></i>Cancel</a>
