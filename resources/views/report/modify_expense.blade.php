            ...
            <div class="col-md-11 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="centar_horizontal"><h3 class="th3">{{$supermarket['name']}} - Modify Expense</h3>  </div>
                        <div class="row">
                            <div class="col-sm-8 offset-md-2">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2><i class="fa fa-shopping-cart"></i> Expense <small> Supermarket</small></h2>
                                        <ul class="nav navbar-right panel_toolbox"><li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a> </li></ul>
                                        <div class="clearfix"></div>
                                    </div>
                                    <div class="x_content">

                                        <form method="post" action="{{ route('modifying_expense', ["id_supermarket" => $supermarket['id']]) }}" class="form-horizontal form-label-left">
                                            @csrf
                                            <input type="hidden" id="inputIdSupermarket" name="inputIdSupermarket" value="{{$supermarket['id']}}">
                                            <input type="hidden" id="inputIdExpense" name="inputIdExpense" value="{{$info['id']}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10 col-sm-10 ">
                                                    <input type="text" class="form-control" id="inputConcept" name="inputConcept" value="{{$info["concept"]}}" autocomplete="off" required>
